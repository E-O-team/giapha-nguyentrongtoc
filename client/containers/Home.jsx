        ...
        const Mobile = () => (
            <Box height='100vh'>
                <Box pad={{horizontal: 'large'}} gap='large' wrap={true}>
                    <Box elevation='large' background='blend' pad='small' justify='center' align='center' width='medium' height='60px'><Heading margin='0px' size='32px' color='brand'>GIA TỘC PHẠM PHÚ</Heading></Box>
            ...
            return(
                <Box height='100vh'>
                    <Box pad={{horizontal: 'medium'}} gap='small' wrap={true}>
                        <Box elevation='large' background='blend' pad='medium' width='medium' justify='center' align='center'><Heading margin='0px' size='30px' color='brand'>GIA TỘC PHẠM PHÚ</Heading></Box>
